...
warnings.filterwarnings("ignore", message=".*garbage collector.*", category=sqlalchemy.exc.SAWarning)
warnings.filterwarnings("ignore", message=".*non-checked-in connection.*", category=sqlalchemy.exc.SAWarning)
warnings.filterwarnings("ignore", message=".*The garbage collector is trying to clean up.*")
