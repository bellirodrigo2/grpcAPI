...
class CompileErrorCode(Enum):
    ...
    METHOD_NO_REQUEST = "E802"
    METHOD_TOO_MANY_REQUEST = "E803"
    METHOD_INVALID_RESPONSE_TYPE = "E804"
    METHOD_RETURN_STREAM_IS_NOT_ASYNC_GENERATOR = "E805"
    METHOD_INVALID_DESCRIPTION_TYPE = "E806"
    METHOD_OPTIONS_NOT_DICT = "E807"
    METHOD_OPTION_KEY_NOT_STRING = "E808"
    METHOD_OPTION_VALUE_INVALID = "E809"
