...
class User(google.protobuf.message.Message):
    ...
    @property
    def circular(self) -> global___Circular: ...
    @property
...
class Circular(google.protobuf.message.Message):
    ...
    CIRCULAR_USER_FIELD_NUMBER: builtins.int
    @property
    def circular_user(self) -> global___User: ...
    def __init__(
        self,
        *,
