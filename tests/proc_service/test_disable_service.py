...
class TestDisableService:
    ...
    def test_no_filter_keeps_all_active(self):
        ...
        service = MockService(name="TestService", package="com.example", module="user_service")
        method = MockMethod(name="create_user", package="com.example", module="user_service")
    ...
    def test_complex_real_world_scenario(self):
        ...
        disable_service = DisableService(
            service_filter={
                "package": {"include": ["com.myapp.*"], "exclude": ["com.myapp.test.*"]},
        ...
        legacy_service = MockService(
            package="com.myapp.old",
            module="legacy_handler",
            tags=["v2"]
        )
